(function(T, $, p) {
    ...
    function wa() {
        for (var b = X.length, a; b;) {
            b--;
            a = X[b].charCodeAt(0);
            if (a == 57) return X[b] = "A", X.join("");
            if (a == 90) X[b] = "0";
            else return X[b] = String.fromCharCode(a + 1), X.join("")
        }
        X.unshift("0");
        return X.join("")
    }
    ...
    function U(b, a) {
        ...
        if (a) {
            if (b ===
                a) throw z("Can't copy equivalent objects or arrays");
            if (K(b)) {
                for (; a.length;) a.pop();
    ...
    function ea(b, a) {
        ...
        if (c == typeof a &&
            ...
            } else if (ma(b)) return ma(a) && b.getTime() == a.getTime();
        else {
            if (b && b.$evalAsync && b.$watch || a && a.$evalAsync && a.$watch || na(b) || na(a)) return !1;
            c = {};
            for (d in b) {
                if (d.charAt(0) !== "$" && !M(b[d]) && !ea(b[d], a[d])) return !1;
                c[d] = !0
            }
            for (d in a)
    ...
    function Va(b, a) {
        ...
        return M(a) && !(a instanceof RegExp) ? c.length ?
            function() {
    ...
    function hc(b, a) {
        var c = a;
        /^\$+/.test(b) ? c = p : na(a) ? c = "$WINDOW" : a && $ === a ? c = "$DOCUMENT" : a && a.$evalAsync && a.$watch && (c = "$SCOPE");
        return c
    }
    function aa(b, a) {
    ...
    function qa(b, a, c) {
        ...
        pa(M(b), a, "not a function, got " + (b && typeof b == "object" ? b.constructor.name || "Object" : typeof b));
        return b
    }
    function kc(b) {
        function a(a, b, e) {
    ...
    function ab(b, a) {
        function c() {
            var e;
            for (var b = [this], c = a, h, f, i, j, k, l, n; b.length;) {
                h = b.shift();
                f = 0;
                for (i = h.length; f < i; f++) {
                    j = u(h[f]);
                    c ? (n = (k = j.data("events")) && k.$destroy) && m(n, function(a) {
                        a.handler()
                    }) : c = !c;
                    k = 0;
                    for (e = (l = j.children()).length, j = e; k < j; k++) b.push(ha(l[k]))
                }
            }
    ...
    function sb(b, a, c) {
        var d = ba(b, "events");
        ba(b, "handle") && (v(a) ? m(d, function(a, c) {
            tb(b, c, a);
            delete d[c]
        }) : v(c) ? (tb(b, a, d[a]),
            delete d[a]) : za(d[a], c))
    ...
    function ba(b, a, c) {
        var d = b[Aa],
            d = Ba[d || -1];
        if (s(c)) d || (b[Aa] = d = ++nc, d = Ba[d] = {}), d[a] = c;
        else return d && d[a]
    }
    function ub(b, a, c) {
        var d = ba(b, "data"),
    ...
    function oc(b, a) {
        var c = function(c, e) {
            ...
            Y <= 8 ? (c.preventDefault = null, c.stopPropagation = null, c.isDefaultPrevented = null) : (delete c.preventDefault, delete c.stopPropagation, delete c.isDefaultPrevented)
        };
        c.elem = b;
        return c
    }
    ...
    function Ab(b) {
        ...
        if (typeof b == "function") {
            if (!(a = b.$inject)) a = [], c = b.toString().replace(pc,
                ""), c = c.match(qc), m(c[1].split(rc), function(b) {
                b.replace(sc, function(b, c, d) {
                    a.push(d)
                })
            }), b.$inject = a
        } else K(b) ? (c = b.length - 1, qa(b[c], "fn"), a = b.slice(0, c)) : qa(b, "fn", !0);
        return a
    }
    function pb(b) {
        function a(a) {
        ...
        function c(a, b) {
            M(b) && (b = l.instantiate(b));
            if (!b.$get) throw z("Provider " + a + " must define $get factory method.");
            return k[a + f] = b
        }
        function d(a, b) {
            return c(a, {
        ...
        function g(a, b) {
            function c(d) {
                if (typeof d !==
                    "string") throw z("Service name expected");
            ...
            function d(a, b, e) {
                var f = [],
                    ...
                    j, h, o;
                h = 0;
                for (j = g.length; h < j; h++) o = g[h], f.push(e && e.hasOwnProperty(o) ? e[o] : c(o, i));
                a.$inject || (a = a[j]);
                switch (b ? -1 : f.length) {
                    case 0:
                        return a();
    ...
    function uc(b, a, c, d) {
        ...
        function h() {
            fa != f.url() && (fa = f.url(), m(y, function(a) {
                a(f.url())
            }))
        }
        var f = this,
        ...
        f.notifyWhenNoOutstandingRequests =
            function(a) {
                m(q, function(a) {
                    a()
                });
        ...
        var fa = j.href,
            A = a.find("base");
        f.url = function(a, b) {
            return a ? (fa = a, d.history ? b ? k.replaceState(null, "", a) : (k.pushState(null, "", a), A.attr("href", A.attr("href"))) : b ? j.replace(a) : j.href = a, f) : j.href.replace(/%27/g, "'")
        };
        var y = [],
            L = !1;
        f.onUrlChange = function(a) {
            L || (d.history && u(b).bind("popstate", h), d.hashchange ? u(b).bind("hashchange", h) : f.addPollFn(h), L = !0);
            y.push(a);
            return a
        };
        f.baseHref =
        ...
        f.cookies = function(a, b) {
            var d, e, f, g;
            if (a)
                if (b === p) i.cookie = escape(a) + "=;path=" + N + ";expires=Thu, 01 Jan 1970 00:00:00 GMT";
                else {
                ...
                if (i.cookie !== H) {
                    ...
                    d = H.split("; ");
                    V = {};
                    for (f = 0; f < d.length; f++) e = d[f], g = e.indexOf("="), g > 0 && (V[unescape(e.substring(0, g))] = unescape(e.substring(g + 1)))
                }
                return V
            }
        };
            ...
            function b(b,
                ...
                return a[b] = {
                    put: function(a, b) {
                        ...
                        e(c);
                        v(b) || (a in i || h++, i[a] = b, h > j && this.remove(n.key))
                    },
                    get: function(a) {
                        var b = k[a];
                        if (b) return e(b), i[a]
    ...
    function Bb(b) {
        ...
        this.directive = function f(d, e) {
            G(d) ? (pa(e, "directive"), a.hasOwnProperty(d) || (a[d] = [], b.factory(d + c, ["$injector", "$exceptionHandler", function(b, c) {
                var e = [];
                m(a[d], function(a) {
                    try {
                        var f = b.invoke(a);
                        ...
                        else if (!f.compile && f.link) f.compile = B(f.link);
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler",
            "$http", "$templateCache", "$parse", "$controller", "$rootScope",
            function(b, i, j, k, l, n, r, o) {
                function w(a, b, c) {
                    a instanceof u || (a = u(a));
                    m(a, function(b, c) {
                        b.nodeType == 3 && (a[c] = u(b).wrap("<span>").parent()[0])
                    });
                    var d = t(a, b, a, c);
                    return function(b, c) {
                        pa(b, "scope");
                ...
                function t(a, b, c, d) {
                    function e(a, c, d, g) {
                        for (var j, i, n, k, l, o = 0, r = 0, q = f.length; o < q; r++) n = c[r], j = f[o++], i = f[o++],
                            j ? (j.scope ? (k = a.$new(J(j.scope)), u(n).data("$scope", k)) : k = a, (l = j.transclude) || !g && b ? j(i, k, n, d, function(b) {
                                return function(c) {
                                    var d = a.$new();
                    ...
                    for (var f = [], g, j, i, n = 0; n < a.length; n++) j = new ca, g = fa(a[n], [], j, d), j = (g = g.length ? A(g, a[n], j, b, c) : null) && g.terminal ? null : t(a[n].childNodes, g ? g.transclude : b), f.push(g), f.push(j), i = i || g || j;
                    return i ? e : null
                }
                function fa(a, b, c, f) {
                    var g = c.$attr,
                    ...
                    switch (a.nodeType) {
                        case 1:
                            y(b,
                                da(Cb(a).toLowerCase()), "E", f);
                            var i, n, k;
                            j = a.attributes;
                            for (var l = 0, o = j && j.length; l < o; l++)
                                if (i = j[l], i.specified) n = i.name, k = da(n.toLowerCase()), g[k] = n, c[k] = i = Q(Y && n == "href" ? decodeURIComponent(a.getAttribute(n, 2)) : i.value), yb(a, k) && (c[k] = !0), W(a, b, i, k), y(b, k, "A", f);
                            a = a.className;
                            if (G(a))
                                for (; j = e.exec(a);) k = da(j[2]), y(b, k, "C", f) && (c[k] = Q(j[3])), a = a.substr(j.index + j[0].length);
                            break;
                        case 3:
                            F(b, a.nodeValue);
                            break;
                        case 8:
                            try {
                                if (j = d.exec(a.nodeValue)) k = da(j[1]), y(b, k, "M", f) && (c[k] = Q(j[2]))
                            } catch (r) {}
                    }
                    b.sort(H);
                    return b
                ...
                function A(a, b, c, d, e) {
                    function f(a, b) {
                        if (a) a.require = E.require, o.push(a);
                        if (b) b.require = E.require, t.push(b)
                    }
                    function i(a, b) {
                        var c, d = "data",
                            e = !1;
                        if (G(a)) {
                            ...
                            c = b[d]("$" + a + "Controller");
                            if (!c && !e) throw z("No controller: " + a);
                    ...
                    function k(a, d, e, f, g) {
                        var l, q, w, L, Ha;
                        l = b === e ? c : gc(c, new ca(u(e), c.$attr));
                        q = l.$$element;
                        if (A && J(A.scope)) {
                            var yc = /^\s*([@=&])\s*(\w*)\s*$/,
                                ja = d.$parent || d;
                            m(A.scope, function(a, b) {
                                ...
                                switch (c[1]) {
                                    ...
                                    case "=":
                                        ...
                                        j = g.assign || function() {
                                            f = d[b] = g(ja);
                                            throw z(Db + l[e] + " (directive: " + A.name + ")");
                                        };
                                        f = d[b] = g(ja);
                                        d.$watch(function() {
                                            var a = g(ja);
                                            a !== d[b] && (a !== f ? f = d[b] = a : j(ja, f = d[b]));
                                            return a
                                        });
                                        break;
                                    case "&":
                                        ...
                                        break;
                                    default:
                                        throw z("Invalid isolate scope definition for directive " + A.name +
                                            ": " + a);
                                }
                            })
                        }
                        s && m(s, function(a) {
                            ...
                            Ha = a.controller;
                            Ha == "@" && (Ha = l[a.name]);
                            q.data("$" + a.name + "Controller", r(Ha, b))
                        });
                        f = 0;
                        for (w = o.length; f < w; f++) try {
                            L = o[f], L(d, q, l, L.require && i(L.require, q))
                        } catch (y) {
                            j(y, oa(q))
                        }
                        a && a(d, e.childNodes, p, g);
                        f = 0;
                        for (w = t.length; f < w; f++) try {
                            L = t[f], L(d, q, l, L.require && i(L.require, q))
                        } catch (H) {
                            j(H, oa(q))
                        }
                    }
                    for (var l = -Number.MAX_VALUE, o = [], t = [], A = null, y = null, H = null, F = c.$$element = u(b), E, W, Z, x, v = d, s, D, B, C = 0, I = a.length; C < I; C++) {
                        E = a[C];
                        Z = p;
                        if (l > E.priority) break;
                        if (B = E.scope) N("isolated scope", y, E, F), J(B) && (q(F, "ng-isolate-scope"), y = E), q(F, "ng-scope"), A = A || E;
                        W = E.name;
                        if (B = E.controller) s = s || {}, N("'" + W + "' controller", s[W], E, F), s[W] = E;
                        if (B = E.transclude) N("transclusion", x, E, F), x = E, l = E.priority, B == "element" ? (Z = u(b), F = c.$$element = u("<\!-- " + W + ": " + c[W] + " --\>"), b = F[0], Ga(e, u(Z[0]), b), v = w(Z, d, l)) : (Z = u(cb(b)).contents(), F.html(""), v = w(Z, d));
                        if (B = E.template)
                            if (N("template", H, E, F), H = E, Z = u("<div>" + Q(B) + "</div>").contents(), b = Z[0], E.replace) {
                                if (Z.length !=
                                    1 || b.nodeType !== 1) throw new z(g + B);
                                Ga(e, F, b);
                                W = {
                                    $attr: {}
                                };
                                a = a.concat(fa(b, a.splice(C + 1, a.length - (C + 1)), W));
                                L(c, W);
                                I = a.length
                            } else F.html(B);
                        if (E.templateUrl) N("template", H, E, F), H = E, k = V(a.splice(C, a.length - C), k, F, c, e, E.replace, v), I = a.length;
                        else if (E.compile) try {
                            D = E.compile(F, c, v), M(D) ? f(null, D) : D && f(D.pre, D.post)
                        } catch (O) {
                            j(O, oa(F))
                        }
                        if (E.terminal) k.terminal = !0, l = Math.max(l, E.priority)
                    }
                    k.scope = A && A.scope;
                    k.transclude = x && v;
                    return k
                ...
                function y(d, e, g, i) {
                    ...
                    if (a.hasOwnProperty(e))
                        for (var k, e = b.get(e +
                                c), l = 0, o = e.length; l < o; l++) try {
                            if (k = e[l], (i === p || i > k.priority) && k.restrict.indexOf(g) != -1) d.push(k), n = !0
                        } catch (r) {
                            j(r)
                        }
                    return n
                ...
                function V(a, b, c, d, e, f, j) {
                    ...
                    k.get(q.templateUrl, {
                        ...
                        var l, q;
                        if (f) {
                            q = u("<div>" + Q(k) + "</div>").contents();
                            l = q[0];
                            if (q.length != 1 || l.nodeType !== 1) throw new z(g + k);
                            k = {
                                $attr: {}
                            };
                            Ga(e, c, l);
                        ...
                        a.unshift(w);
                        n = A(a, c, d, j);
                        for (o = t(c.contents(), j); i.length;) {
                            var m = i.pop(),
                                k = i.pop();
                            q = i.pop();
                            var y = i.pop(),
                                H = l;
                            q !== r && (H = cb(l), Ga(k, u(q), H));
                            n(function() {
                                b(o, y, H, e, m)
                            }, y, H, e, m)
                        }
    ...
    function Dc() {
        ...
        this.$get = ["$parse", function(c) {
            var d = b.length,
                e = a.length;
            return function(g, h) {
                for (var f, i, j = 0, k = [], l = g.length, n = !1, r = []; j < l;)(f = g.indexOf(b, j)) != -1 && (i = g.indexOf(a, f + d)) != -1 ? (j != f && k.push(g.substring(j, f)), k.push(j = c(n = g.substring(f + d, i))), j.exp = n, j = i + e, n = !0) : (j != l && k.push(g.substring(j)), j = l);
                if (!(l = k.length)) k.push(""), l = 1;
                if (!h || n) return r.length = l, j = function(a) {
                    for (var b = 0, c = l, d; b < c; b++) {
                        if (typeof(d = k[b]) == "function") d = d(a), d == null || d == p ? d =
                            "" : typeof d != "string" && (d = aa(d));
                        r[b] = d
                    }
                    return r.join("")
                }, j.exp = g, j.parts = k, j
    ...
    function Ec(b, a, c) {
        var d = ua(b);
        return decodeURIComponent(d.path) != a || v(d.hash) ||
    ...
    function Fc(b, a, c) {
        ...
        if (decodeURIComponent(d.path) == a) return b;
            ...
            if (d.path.indexOf(h) !== 0) throw z('Invalid url "' + b + '", missing path prefix "' + h + '" !');
    ...
    function fb(b, a, c) {
        ...
        this.$$parse = function(b) {
            var c = ua(b,
                this);
            if (c.path.indexOf(a) !== 0) throw z('Invalid url "' + b + '", missing path prefix "' + a + '" !');
    ...
    function Ia(b, a, c) {
        ...
        this.$$parse = function(b) {
            var c = ua(b, this);
            if (c.hash && c.hash.indexOf(a) !== 0) throw z('Invalid url "' + b + '", missing hash prefix "' + a + '" !');
    ...
    function Hc() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function(c, d, e, g) {
            ...
            var f, i, j, k = d.url(),
                l = ua(k);
            a ? (i = d.baseHref() || "/", j = i.substr(0, i.lastIndexOf("/")), l = ka(l.protocol, l.host, l.port) + j + "/", f = e.history ? new fb(Ec(k, i, b), j, l) : new Hb(Fc(k, i, b), b, l, i.substr(j.length + 1))) : (l = ka(l.protocol, l.host,
                l.port) + (l.path || "") + (l.search ? "?" + l.search : "") + "#" + b + "/", f = new Ia(k, b, l));
            g.bind("click", function(a) {
                if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
                    for (var b = u(a.target); C(b[0].nodeName) !== "a";) {
                        if (b[0] === g[0]) return;
                        b = b.parent()
                    }
                    var d = b.prop("href"),
    ...
    function Jc(b, a) {
        ...
        function i(a, c, d) {
            d = d || o;
            throw z("Lexer Error: " + a + " at column" + (s(c) ? "s " + c + "-" + o + " [" + b.substring(c, d) + "]" : " " + d) + " in expression [" + b + "].");
        }
        ...
        function j() {
            for (var a = "", c = o; o < b.length;) {
                ...
                if (j == "." || e(j)) a += j;
                    ...
                    else if (f(j) && (!g || !e(g)) && a.charAt(a.length - 1) == "e") i("Invalid exponent");
                    else break
                }
                o++
            }
        ...
        function k() {
            for (var c = "", d = o, f, j, i; o < b.length;) {
                var k = b.charAt(o);
        ...
        function l(a) {
            ...
            for (var d = "", f = a, e = !1; o < b.length;) {
                var j = b.charAt(o);
                f += j;
                if (e) j == "u" ? (j = b.substring(o + 1, o + 5), j.match(/[\da-f]{4}/i) || i("Invalid unicode escape [\\u" + j + "]"), o += 4, d += String.fromCharCode(parseInt(j, 16))) : (e = Kc[j], d += e ? e : j), e = !1;
                else if (j == "\\") e = !0;
                else if (j == a) {
                    o++;
                    n.push({
        ...
        for (var n = [], r, o = 0, w = [], q, t = ":"; o < b.length;) {
            q = b.charAt(o);
            if (c("\"'")) l(q);
            else if (e(q) ||
                c(".") && e(d())) j();
            else if (h(q)) {
                if (k(), "{,".indexOf(t) != -1 && w[0] == "{" && (r = n[n.length - 1])) r.json = r.text.indexOf(".") == -1
            } else if (c("(){}[].,;:")) n.push({
                index: o,
                text: q,
                json: ":[,".indexOf(t) != -1 && c("{[") || c("}]:,")
    ...
    function Lc(b, a,
        ...
        function g() {
            if (N.length === 0) throw z("Unexpected end of expression: " + b);
            return N[0]
        }
        ...
        function l() {
            for (var a = [];;)
                if (N.length > 0 && !h("}", ")", ";", "]") && a.push(v()), !f(";")) return a.length == 1 ? a[0] : function(b, c) {
        ...
        function A() {
            ...
            for (var c; b = f("(", "[", ".");) b.text === "(" ? (a = u(a, c), c = null) : b.text === "[" ? (c = a, a = ca(a)) : b.text === "." ? (c = a, a = s(a)) : e("IMPOSSIBLE");
            return a
        }
        ...
        var V = B(0),
            ...
            u = function(a, b) {
                ...
                return function(d, f) {
                    for (var e = [], j = b ? b(d, f) : d, g = 0; g < c.length; g++) e.push(c[g](d,
                        f));
                    g = a(d, f) || x;
                    return g.apply ? g.apply(j, e) : g(e[0], e[1], e[2], e[3], e[4])
                }
            },
            s = function(a) {
                var b = f().text,
            ...
            ca = function(a) {
                ...
                return D(function(c, d) {
                    ...
                    if ((f = f[e]) && f.then) {
                        j = f;
                        if (!("$$v" in f)) j.$$v = p, j.then(function(a) {
                            j.$$v = a
                        });
                        f = f.$$v
                    }
        ...
        a ? (F = r, u = s = ca = v = function() {
            e("is not valid json", {
                text: b,
                index: 0
            })
        }, H = A()) : H = l();
        N.length !== 0 && e("is an unexpected token", N[0]);
        return H
    }
    ...
    function Lb(b, a, c, d, e) {
        return function(g, h) {
            ...
            if (f ===
                null || f === p) return f;
            if ((f = f[b]) && f.then) {
                if (!("$$v" in f)) i = f, i.$$v = p, i.then(function(a) {
                    i.$$v = a
                });
                f = f.$$v
            }
    ...
    function Jb(b, a) {
        ...
        if (a) e = d < 6 ? Lb(c[0], c[1], c[2], c[3], c[4]) : function(a, b) {
            var e = 0,
                j;
            do j = Lb(c[e++], c[e++], c[e++], c[e++], c[e++])(a, b), b = p, a = j; while (e < d);
            return j
        };
        else {
            var g = "var l, fn, p;\n";
    ...
    function Pc() {
        ...
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache", function(a, c, d, e, g, h, f) {
            function i() {
                var b = j(),
                    i = r.current;
                if (b && i && b.$route === i.$route &&
                    ea(b.pathParams, i.pathParams) && !b.reloadOnSearch && !n) i.params = b.params, U(i.params, d), a.$broadcast("$routeUpdate", i);
                else if (b || i) n = !1, a.$broadcast("$routeChangeStart", b, i), (r.current = b) && b.redirectTo && (G(b.redirectTo) ? c.path(k(b.redirectTo, b.params)).search(b.params).replace() : c.url(b.redirectTo(b.pathParams, c.path(), c.search())).replace()), e.when(b).then(function() {
                    if (b) {
                        var a = [],
                            c = [],
                            d;
                        m(b.resolve || {}, function(b, d) {
                            a.push(d);
                            c.push(M(b) ? g.invoke(b) : g.get(b))
                        });
                        if (!s(d = b.template))
                            if (s(d = b.templateUrl)) d =
                                h.get(d, {
                                    cache: f
                                }).then(function(a) {
                                    return a.data
                                });
                        s(d) && (a.push("$template"), c.push(d));
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", function(a, c, d) {
            ...
            e.prototype = {
                $new: function(a) {
                    ...
                    this.$$childHead ? this.$$childTail = this.$$childTail.$$nextSibling =
                        a : this.$$childHead = this.$$childTail = a;
                    return a
                },
                            ...
                            if (h = t.$$watchers)
                                for (o = h.length; o--;) try {
                                    if (a = h[o], (d = a.get(t)) !== (e = a.last) &&
                                        !(a.eq ? ea(d, e) : typeof d == "number" && typeof e == "number" && isNaN(d) && isNaN(e))) m = !0, a.last = a.eq ? U(d) : d, a.fn(d, e === f ? d : e, t), q < 5 && (A = 4 - q, p[A] || (p[A] = []), y = M(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) : a.exp, y += "; newVal: " + aa(d) + "; oldVal: " + aa(e), p[A].push(y))
                                } catch (V) {
                                    c(V)
                                }
                ...
                $broadcast: function(a, b) {
                    ...
                    do
                        if (d = e, f.currentScope = d, m(d.$$listeners[a], function(a) {
                            ...
                            for (; d !== this && !(e = d.$$nextSibling);) d = d.$parent; while (d = e);
                    return f
                }
            };
            var i = new e;
        ...
        var b = /^\s*(\[|\{[^\{])/,
            ...
            d = this.defaults = {
                transformResponse: [function(d) {
                    G(d) && (d = d.replace(c, ""), b.test(d) && a.test(d) && (d = mb(d, !0)));
                    return d
                }],
                transformRequest: [function(a) {
                    return J(a) && Sa.apply(a) !== "[object File]" ? aa(a) : a
                }],
                headers: {
                    common: {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, b, c, i, j, k) {
            function l(a) {
                ...
                var e = a.transformRequest || d.transformRequest,
                    ...
                    e = Ob(a.data, Nb(g), e),
                    i;
                v(a.data) && delete g["Content-Type"];
                i = n(a, e, g);
                i = i.then(c, c);
                m(w, function(a) {
                    i = a(i)
            ...
            function n(b, c, d) {
                ...
                function f(a,
                    c, d) {
                    c = Math.max(c, 0);
                    (200 <= c && c < 300 ? n.resolve : n.reject)({
                        data: a,
                        status: c,
                        headers: Nb(d),
                        config: b
                ...
                k.then(h, h);
                b.cache && b.method == "GET" && (m = J(b.cache) ? b.cache : o);
                if (m)
                    if (p = m.get(w))
                        if (p.then) return p.then(h, h), p;
                        else K(p) ? f(p[1], p[0], U(p[2])) : f(p, 200, {});
                else m.put(w, k);
            ...
            function r(a,
                ...
                var c = [];
                dc(b, function(a, b) {
                    a == null || a == p || (J(a) && (a = aa(a)), c.push(encodeURIComponent(b) + "=" + encodeURIComponent(a)))
                });
    ...
    function Wc(b, a, c, d, e, g) {
        ...
        return function(e,
            i, j, k, l, n, r) {
            function o(a, c, d, e) {
                c = (i.match(Fb) || ["", g])[1] == "file" ? d ? 200 : 404 : c;
                a(c == 1223 ? 204 : c, d, e);
        ...
        return function(b, a) {
            ...
            var d = function(a, b) {
                ...
                switch (typeof a) {
                    ...
                    case "number":
                    case "string":
                        return ("" + a).toLowerCase().indexOf(b) >
                            -1;
                    case "object":
                        for (var c in a)
    ...
    function Ub(b, a, c, d, e) {
        ...
        if (h.indexOf("e") !== -1) f = h;
            ...
            var h = Math.pow(10, e),
                ...
                l = a.gSize;
            if (h.length >= k + l)
                for (var j = h.length - k, n = 0; n < j; n++)(j - n) % l === 0 && n !== 0 && (f += c), f += h.charAt(n);
        ...
        function a(a) {
            ...
            if (b = a.match(c)) {
                var a = new Date(0),
                    g = 0,
                    h = 0;
                b[9] && (g = I(b[9] + b[10]), h = I(b[9] + b[11]));
                a.setUTCFullYear(I(b[1]), I(b[2]) - 1, I(b[3]));
                a.setUTCHours(I(b[4] || 0) - g, I(b[5] || 0) - h, I(b[6] || 0), I(b[7] || 0))
            }
            return a
        }
    ...
    function ib(b, a) {
        ...
        return R(function(c, d, e) {
            c.$watch(e[b], function(b, e) {
                if (a === !0 || c.$index %
                    2 === a) e && b !== e && (J(e) && !K(e) && (e = Ta(e, function(a, b) {
                    if (a) return b
    ...
    var C = function(b) {
        ...
        z = T.Error,
        Y = I((/msie (\d+)/.exec(C(navigator.userAgent)) || [])[1]),
        u, ha, ga = [].slice,
        Ra = [].push,
    ...
    m({
        ...
        css: function(b, a, c) {
            ...
            if (s(c)) b.style[a] = c;
                ...
                var d;
                Y <= 8 && (d = b.currentStyle && b.currentStyle[a], d === "" && (d = "auto"));
                d = d || b.style[a];
                Y <= 8 && (d = d === "" ? p : d);
                return d
            }
        ...
        attr: function(b, a, c) {
            ...
            if (Ea[d])
                if (s(c)) c ? (b[a] = !0,
                    b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d));
                else return b[a] || (b.attributes.getNamedItem(a) || x).specified ? d : p;
    ...
    fb.prototype = {
        ...
        search: function(a, c) {
            if (v(a)) return this.$$search;
            s(c) ? c === null ? delete this.$$search[a] : this.$$search[a] = c : this.$$search = G(a) ? Xa(a) : a;
            this.$$compose();
            return this
        },
        hash: Ib("$$hash", ya),
    ...
    Ia.prototype = xa(fb.prototype);
    Hb.prototype = xa(Ia.prototype);
    var Ka = {
            "null": function() {
                return null
            },
    ...
    var Ra = {
        ...
        $b = {
            ...
            number: function(a, c, d, e, g, h) {
                ...
                e.$parsers.push(function(a) {
                    var c = S(a);
                    return c || od.test(a) ? (e.$setValidity("number", !0), a === "" ? null : c ? a : parseFloat(a)) : (e.$setValidity("number",
                        !1), p)
                });
        ...
        pd = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", function(a, c, d, e, g) {
            ...
            this.$setValidity = function(a, c) {
                if (k[a] !== !c) {
                    if (c) {
                        if (k[a] && j--, !j) h(!0), this.$valid = !0, this.$invalid = !1
                    } else h(!1), this.$invalid = !0, this.$valid = !1, j++;
                    k[a] = !c;
                    h(c, a);
            ...
            this.$setViewValue = function(d) {
                this.$viewValue = d;
                if (this.$pristine) this.$dirty = !0, this.$pristine = !1, e.removeClass(Pa).addClass(Xb), i.$setDirty();
                m(this.$parsers,
                    function(a) {
                        d = a(d)
                    });
                if (this.$modelValue !== d) this.$modelValue = d, f(a, d), m(this.$viewChangeListeners, function(a) {
                    try {
                        a()
                    } catch (d) {
                        c(d)
            ...
            a.$watch(g, function(a) {
                if (l.$modelValue !== a) {
                    ...
                    if (l.$viewValue !== a) l.$viewValue = a, l.$render()
                }
            })
        }],
        qd = function() {
        ...
        sd = function() {
            return {
                ...
                link: function(a, c, d, e) {
                    ...
                    e.$parsers.push(h);
                    e.$formatters.push(function(a) {
                        return K(a) && !ea(h(e.$viewValue), a) ? a.join(", ") : p
                    })
                }
            }
        },
        ...
        Jd = R({
            ...
            compile: function(a, c, d) {
                return function(a,
                    ...
                    i = h[2];
                    h = f.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/);
                    if (!h) throw z("'item' in 'item in collection' should be identifier or (key, value) but got '" + f + "'.");
                    j = h[3] || h[1];
                    k = h[2];
                    var l = new db;
                    a.$watch(function(a) {
                        ...
                        if (K(h)) v = h || [];
                            ...
                            v = [];
                            for (A in h) h.hasOwnProperty(A) && A.charAt(0) !=
                                "$" && v.push(A);
                            v.sort()
                        }
                        e = 0;
                        for (f = v.length; e < f; e++) {
                            ...
                            if (s = l.shift(y)) {
                                p = s.scope;
                                u.push(y, s);
                                if (e !== s.index) s.index = e, z.after(s.element);
                                z = s.element
                            } else p = a.$new();
                            p[j] = y;
                            k && (p[k] = A);
            ...
            compile: function(a, c) {
                ...
                return function(a, h) {
                    ...
                    a.$watch(d, function(d) {
                        i && (j.$destroy(), i.remove(), i = j = null);
                        if (f = e["!" + d] || e["?"]) a.$eval(c.change), j = a.$new(), f(j, function(a) {
                            i =
                                a;
                            h.append(a)
                        })
                    ...
                    function k() {
                        ...
                        if (k) {
                            ...
                            var k = g(c.contents()),
                                m = d.current;
                            l = m.scope = a.$new();
                            if (m.controller) j.$scope = l, j = h(m.controller, j), c.contents().data("$ngControllerController", j);
                            k(l);
            ...
            return {
                ...
                link: function(e, h, f, i) {
                    function j(a, c, d, e) {
                        d.$render = function() {
                            var a = d.$viewValue;
                            e.hasOption(a) ? (y.parent() && y.remove(), c.val(a), a === "" && t.prop("selected",
                    ...
                    function l(e,
                        ...
                        function i() {
                            ...
                            for (x = 0; z = y.length, x < z; x++) {
                                ...
                                o ? d = t.remove(n(e, w)) != p : (d = s === n(e, w), t = t || d);
                                h.push({
                                    id: l ? y[x] : x,
                                    label: j(e, w) || "",
                                    selected: d
                            ...
                            for (y = c.length; w < y; w++) {
                                ...
                                if (v.length <=
                                    ...
                                    label: h.label
                                }, u = [s], v.push(u), f.append(s.element);
                                else if (u = v[w], s = u[0], s.label != d) s.element.attr("label", s.label = d);
                                B = null;
                                x = 0;
                                for (z = h.length; x < z; x++)
                                    if (d = h[x], t = u[x + 1]) {
                                        B = t.element;
                                        if (t.label !== d.label) B.text(t.label = d.label);
                                        if (t.id !== d.id) B.val(t.id = d.id);
                                        if (t.element.selected !== d.selected) B.prop("selected", t.selected = d.selected)
                                    } else d.id === "" && q ? C = q : (C = D.clone()).val(d.id).attr("selected", d.selected).text(d.label), u.push({
                                        element: C,
                                        label: d.label,
                                        id: d.id,
                                        selected: d.selected
                                ...
                                if (o) {
                                    ...
                                    for (s = v.length; m < s; m++) {
                                        ...
                                        for (q = a.length; j < q; j++)
                                            if ((h = a[j].element)[0].selected) h = h.val(), l && (d[l] = h), d[k] = c[h], i.push(n(e, d))
                                    }
                    ...
                    if (i[1]) {
                        for (var n = i[0], r = i[1], o = f.multiple, w = f.ngOptions, q = !1, t, D = u($.createElement("option")), A = u($.createElement("optgroup")), y = D.clone(), i = 0, x = h.children(), B = x.length; i < B; i++)
                            if (x[i].value == "") {
                                t = q =
                                    x.eq(i);
                                break
    ...
    }), ab("remove", !0), ab("empty"), ab("html")) : u = P;
    Yb.element = u;
    (function(a) {
        D(a, {
            bootstrap: ob,
